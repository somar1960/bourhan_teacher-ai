...
Defines the groups table and its one-to-many relationships with students,
files, homeworks, and exams.
"""
...
class Group(Base):
    ...
    Each group can contain multiple students, files, homeworks, and exams.
    """
    ...
    files: Mapped[List["File"]] = relationship(
        "File", back_populates="group", lazy="selectin"
    )
    homeworks: Mapped[List["Homework"]] = relationship(
        "Homework", back_populates="group", lazy="selectin"
    )
    exams: Mapped[List["Exam"]] = relationship(
        "Exam", back_populates="group", lazy="selectin"
    )
